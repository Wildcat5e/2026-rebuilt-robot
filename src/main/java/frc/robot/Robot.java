...
public class Robot extends TimedRobot {
    ...
    public Robot() {
        ...
        commands = new RobotCommands(drivetrain, flywheel, hopper, swerveRequest);
    ...
    public void bindingsSetup() {
        ...
        Controller.joystick.a().whileTrue(commands.aimHandler); // PID + Shooting Calculator testing
