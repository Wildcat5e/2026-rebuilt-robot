...
public class PhotonVision extends SubsystemBase {
    ...
    public static PhotonCamera photonCamera = new PhotonCamera("HD_Pro_Webcam_C920");
    public static Transform3d ROBOT_TO_CAMERA = new Transform3d(-0.07, .295, .57, Rotation3d.kZero);
    ...
    public PhotonVision(PoseEstimateConsumer estimateConsumer) {
        this(photonCamera, new PhotonPoseEstimator(AprilTagFieldLayout.loadField(AprilTagFields.k2026RebuiltWelded),
            new Transform3d(-0.07, .295, .57, Rotation3d.kZero)), estimateConsumer);
    }
