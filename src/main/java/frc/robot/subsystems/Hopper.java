...
public class Hopper extends SubsystemBase {
    ...
    public Command testConveyor() {
        return startEnd(
                () -> conveyorMotor.setVoltage(-DashboardManager.getConveyorTestVoltage()),
                () -> conveyorMotor.setVoltage(0))
    ...
    public Command testTunableKicker() {
        return runEnd(
                () -> kickerMotor.setVoltage(-DashboardManager.getKickerTestVoltage()),
                () -> kickerMotor.setVoltage(0))
                .withName("Test Tunable Kicker");
    }
